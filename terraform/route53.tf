moved {
  ...
  to   = aws_route53_record.wildcard_cert_validation
}

# DNS validation for the account-wide *.seanezell.com wildcard certificate
# (used by api/cdn CloudFront distributions in aws-infrastructure)
